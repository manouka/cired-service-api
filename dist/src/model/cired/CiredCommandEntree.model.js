...
exports.CiredCommandEntreeModel = exports.ModelFoo = exports.ModelTest = exports.ciredCommandEntreeValidator = exports.CiredCommandEntree = exports.CiredFlagTimer = exports.CiredFlagIndex = exports.CiredFlagState = exports.CiredAddressEntree = void 0;
...
const ModelFactory_1 = require("../sequelize/ModelFactory");
...
let ModelTest = class ModelTest extends ModelFactory_1.GenericModel {
    static foo() {
        console.log('ModelTest');
    }
};
__decorate([
    (0, ModelFactory_1.OrmColumn)({ type: sequelize_1.DataTypes.INTEGER, name: 'AREA' })
], ModelTest.prototype, "area", void 0);
ModelTest = __decorate([
    (0, ModelFactory_1.OrmModel)({ modelName: 'ModelTest', tableName: 'T_TEST' })
], ModelTest);
exports.ModelTest = ModelTest;
let ModelFoo = class ModelFoo extends ModelFactory_1.GenericModel {
    static foo() {
...
__decorate([
    (0, ModelFactory_1.OrmColumn)({ type: sequelize_1.DataTypes.INTEGER, name: 'AREA' })
], ModelFoo.prototype, "area", void 0);
ModelFoo = __decorate([
    (0, ModelFactory_1.OrmModel)({ modelName: 'ModelFoo', tableName: 'T_FOO' })
], ModelFoo);
exports.ModelFoo = ModelFoo;
class CiredCommandEntreeModel extends CiredCommandAbstract_model_1.CiredCommandAbstractModel {
...
__decorate([
    (0, CiredDecorator_1.IsCiredValuePropertyAllowed)(CiredCommandAbstract_model_1.CiredArea)
...
//# sourceMappingURL=CiredCommandEntree.model.js.map